...
export function exportSvgToPng({
  ...
  if (!isValidDimension(width) || !isValidDimension(height)) {
    ...
    if (isValidDimension(attrWidth)) width = attrWidth;
    if (isValidDimension(attrHeight)) height = attrHeight;
  }
...
function exportCanvasToPng({
  ...
  if (!isValidDimension(width) && typeof canvasEl.getBoundingClientRect === "function") {
